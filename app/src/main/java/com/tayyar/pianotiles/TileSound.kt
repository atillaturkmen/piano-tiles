...
class TileSound(context: Context) {
    ...
    init {
        try {
            ...
            // read the notes
            val csv = assetManager.open("song/Flight of the Bumblebee.csv")
            val bumblebeeNotes = csv.bufferedReader().readLine().split(",")


            // Load our fx in memory ready for use
            val allNotes = listOf("a")
